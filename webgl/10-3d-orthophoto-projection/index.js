import m4 from '../../util/matrix4.js';
import { deg2rad, rad2deg } from '../../util/index.js';
...
function render() {
	...
	const translation = [90, 300, 0];
	const rotation = [deg2rad(40), deg2rad(25), deg2rad(325)];
	const scale = [1, 1, 1];
